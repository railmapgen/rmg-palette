        ...
        if (this.state.hasError) {
            ...
            return (
                <div {...others}>
                    ...
                    <p>
                        Please try to refresh. If the issue still persists, please consider upgrading your browser or
                        submit an issue in{' '}
                        <a
                    ...
                    <p>
                        請嘗試重新整理。如果問題仍然存在，請考慮更新你的瀏覽器，或前往
                        <a
                            href="https://github.com/railmapgen/rmg-palette/issues"
                            target="_blank"
                            rel="noreferrer"
